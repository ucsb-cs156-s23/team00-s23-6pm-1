          ...
          <Navbar.Collapse>
            ...
            <Nav className="me-auto">
              ...
              >
                ...
                <NavDropdown.Item as={Link} to="/towns/Copenhagen">
                  Copenhagen
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/towns/LosAngeles">
                  Los Angeles
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/towns/Valencia">
                  Valencia
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/towns/LagunaBeach">
                  Laguna Beach
                </NavDropdown.Item>
              </NavDropdown>
            </Nav>
